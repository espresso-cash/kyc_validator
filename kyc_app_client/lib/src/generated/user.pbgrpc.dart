...
class UserServiceClient extends $grpc.Client {
  static final _$sendUserData = $grpc.ClientMethod<$2.SendUserDataRequest, $2.CommonResponse>(
      '/validator.UserService/SendUserData',
      ($2.SendUserDataRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $2.CommonResponse.fromBuffer(value));
  static final _$deleteUserData = $grpc.ClientMethod<$2.DeleteUserDataRequest, $2.CommonResponse>(
      '/validator.UserService/DeleteUserData',
      ($2.DeleteUserDataRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $2.CommonResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$2.CommonResponse> sendUserData($2.SendUserDataRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$sendUserData, request, options: options);
  }

  $grpc.ResponseFuture<$2.CommonResponse> deleteUserData($2.DeleteUserDataRequest request, {$grpc.CallOptions? options}) {
...
abstract class UserServiceBase extends $grpc.Service {
  ...
  UserServiceBase() {
    $addMethod($grpc.ServiceMethod<$2.SendUserDataRequest, $2.CommonResponse>(
        'SendUserData',
        sendUserData_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $2.SendUserDataRequest.fromBuffer(value),
        ($2.CommonResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.DeleteUserDataRequest, $2.CommonResponse>(
        'DeleteUserData',
        deleteUserData_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $2.DeleteUserDataRequest.fromBuffer(value),
        ($2.CommonResponse value) => value.writeToBuffer()));
  ...
  $async.Future<$2.CommonResponse> sendUserData_Pre($grpc.ServiceCall call, $async.Future<$2.SendUserDataRequest> request) async {
    return sendUserData(call, await request);
  }

  $async.Future<$2.CommonResponse> deleteUserData_Pre($grpc.ServiceCall call, $async.Future<$2.DeleteUserDataRequest> request) async {
  ...
  $async.Future<$2.CommonResponse> sendUserData($grpc.ServiceCall call, $2.SendUserDataRequest request);
  $async.Future<$2.CommonResponse> deleteUserData($grpc.ServiceCall call, $2.DeleteUserDataRequest request);
